...
#    test2 = MenuNode.new_node( Hash[:name => "default_name", :url => "/default/url"])
#    assert(test2.class == MenuNode.new_node.class, 'add_node returns not MenuNode')
...
#    test2 = MenuNode.new_node("asdf", 1234, Array)
...
#    test3 = MenuNode.new_node( Hash[:name => "name", :url => "url"], [MenuNode.new_node, MenuNode.new_node, MenuNode.new_node])
#    #assert(test3.get_children == [MenuNode.new_node], 'add_node returns not empty array')
...
#
#    # Проверка after!
#    test5 = MenuNode.new_node
#    #test5.set_children= [node1 = MenuNode.new_node, node2 = MenuNode.new_node, node3 = MenuNode.new_node, node4 = MenuNode.new_node]
