...
class PermissionsControllerTest < ActionController::TestCase
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post :create, permission: { description: @permission.description, key: @permission.key, name: @permission.name, params: @permission.params }
    end
  ...
  test "should update permission" do
    put :update, id: @permission, permission: { description: @permission.description, key: @permission.key, name: @permission.name, params: @permission.params }
    assert_redirected_to permission_path(assigns(:permission))
  end
